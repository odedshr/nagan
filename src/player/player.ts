...
function initComponents(progressBar: HTMLInputElement, positionEl: HTMLInputElement) {
  progressBar.addEventListener('change', () =>
    setProgress(parseFloat(progressBar.value), trackMetaData, positionUpdateHandler)
  );
  ...
  positionEl.addEventListener('change', () =>
    validatePositionInput(positionEl.value, trackMetaData.duration, positionUpdateHandler)
  );
}
...
export default function Player(state: State) {
  ...
  positionUpdateHandler = (time: number) => {
    ...
    setCurrentTime(time, elms.get('position') as HTMLInputElement, elms.get('progressBar') as HTMLInputElement);
  };
  ...
  initComponents(elms.get('progressBar') as HTMLInputElement, elms.get('position') as HTMLInputElement);
